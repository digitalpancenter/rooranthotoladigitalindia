...
const AdminRoomAvailable = () => {
  ...
  const fetchData = async () => {
    const res = await fetch("https://rooranthotoladigitalindia.onrender.com/api/room-availability");
  ...
  const handleDelete = async (id) => {
    ...
    await fetch(`https://rooranthotoladigitalindia.onrender.com/api/room-availability/${id}`, {
      method: "DELETE",
    });
